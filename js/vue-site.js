...
var data = [
    {
        ...
        content: [
            ...
            {'href': 'http://www.111.com.cn/', 'name': '掌上药店', 'category': '', 'info': ''},
            {'href': 'http://yz.111.com.cn/', 'name': '易诊', 'category': '', 'info': ''},
            {'href': 'http://dxy.com/', 'name': '丁香医生', 'category': '', 'info': ''},
            {'href': 'http://www.familydoctor.com.cn/', 'name': '家庭医生在线', 'category': '', 'info': ''},
            {'href': 'http://ask.39.net/', 'name': '39问医生', 'category': '', 'info': ''},
            {'href': 'http://www.quyiyuan.com/', 'name': '去医院', 'category': '', 'info': ''},
            {'href': 'http://www.qpgjk.com/', 'name': '青苹果', 'category': '', 'info': ''},
            {'href': 'http://www.kangda.cn/', 'name': '康达预诊', 'category': '', 'info': ''},
            {'href': 'http://www.lehoba.com/', 'name': '中医乐活吧', 'category': '', 'info': ''},
            {'href': 'http://www.yeekang.com/', 'name': '宜康网', 'category': '', 'info': ''},
            {'href': 'http://jiuyibao.hk515.com.cn/', 'name': '就医宝', 'category': '', 'info': ''},
            {'href': 'http://taoyi.qqyy.com/', 'name': '掌上淘医', 'category': '', 'info': ''},
            {'href': 'http://www.huanyou.me/', 'name': '家庭健康卫士', 'category': '', 'info': ''},
            {'href': 'http://www.yihu.com/', 'name': '健康之路', 'category': '', 'info': ''},
            {'href': 'http://www.haoyi365.cn/', 'name': '掌上好医', 'category': '', 'info': ''},
            {'href': 'http://www.yijiankangv.com/', 'name': '壹健康', 'category': '', 'info': ''},
            {'href': 'http://www.daanhealth.com/', 'name': '达安健康', 'category': '', 'info': ''},
            {'href': 'http://www.91160.com/', 'name': '就医160', 'category': '', 'info': ''},
            {'href': 'http://www.91160.com/', 'name': '就医160', 'category': '', 'info': ''},
        ]
    },{
        title: '垂直就医',
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',_vm._l((_vm.categories),function(category){return _c('div',[_c('div',[_c('div',{staticClass:"col-lg-12"},[_c('h2',{staticClass:"page-header"},[_vm._v("\n                    "+_vm._s(category.title)+"\n                ")])])]),_vm._v(" "),_vm._l((category.content),function(site){return _c('div',{staticClass:"col-md-3 col-xs-6 card"},[(site && site.name)?_c('div',[_c('h3',[_c('a',{attrs:{"target":"_blank","href":site.href}},[_vm._v(_vm._s(site.name))])])]):_vm._e()])})],2)}))}
...
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f6c158ae", __vue__options__)
  } else {
...
},{"./components/health-site-model.js":1,"./components/site-model.js":2,"./components/sites.vue":3,"vue":7,"vue-router":6}],5:[function(require,module,exports){
